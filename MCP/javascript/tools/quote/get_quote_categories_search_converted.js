...
export async function get_quote_categories_search(query, start, limit) {
  try {
...
export function createGetQuoteCategoriesSearchTool() {
  return {
    definition: {
      name: 'get-quote-categories-search',
    ...
    handler: get_quote_categories_search
  };
}