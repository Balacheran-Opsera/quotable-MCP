...
export async function get_quote_bookmark_toggle(quote_id) {
  try {
...
export function createGetQuoteBookmarkToggleTool() {
  return {
    definition: {
      name: 'get-quote-bookmark-toggle',
    ...
    handler: get_quote_bookmark_toggle
  };
}