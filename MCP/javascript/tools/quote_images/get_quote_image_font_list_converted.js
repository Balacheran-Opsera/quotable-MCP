...
export async function get_quote_image_font_list(start) {
  try {
...
export function createGetQuoteImageFontListTool() {
  return {
    definition: {
      name: 'get-quote-image-font-list',
    ...
    handler: get_quote_image_font_list
  };
}