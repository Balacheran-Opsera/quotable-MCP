# They Said So Quotes API MCP Server

This MCP (Model Content Protocol) server provides access to They Said So Quotes API API functionality through HTTP, HTTPS, and STDIO transport modes.
