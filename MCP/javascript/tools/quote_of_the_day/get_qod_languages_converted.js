...
export async function get_qod_languages() {
  try {
    ...
    const url = `${config.baseURL}/qod/languages`;
...
export function createGetQodLanguagesTool() {
  return {
    definition: {
      name: 'get-qod-languages',
