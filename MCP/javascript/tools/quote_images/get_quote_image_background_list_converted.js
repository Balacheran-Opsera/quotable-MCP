...
export async function get_quote_image_background_list(start) {
  try {
...
export function createGetQuoteImageBackgroundListTool() {
  return {
    definition: {
      name: 'get-quote-image-background-list',
    ...
    handler: get_quote_image_background_list
  };
}