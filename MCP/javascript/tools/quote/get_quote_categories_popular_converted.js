...
export async function get_quote_categories_popular(start, limit) {
  try {
...
export function createGetQuoteCategoriesPopularTool() {
  return {
    definition: {
      name: 'get-quote-categories-popular',
    ...
    handler: get_quote_categories_popular
  };
}