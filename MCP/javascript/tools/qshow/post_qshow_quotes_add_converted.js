...
export async function post_qshow_quotes_add(id, quoteid) {
  try {
...
export function createPostQshowQuotesAddTool() {
  return {
    definition: {
      name: 'post-qshow-quotes-add',
