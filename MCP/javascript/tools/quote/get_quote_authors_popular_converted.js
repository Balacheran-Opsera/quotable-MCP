...
export async function get_quote_authors_popular(language, start, limit, detailed) {
  try {
...
export function createGetQuoteAuthorsPopularTool() {
  return {
    definition: {
      name: 'get-quote-authors-popular',
    ...
    handler: get_quote_authors_popular
  };
}